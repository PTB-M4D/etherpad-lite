...
ARG ETHERPAD_PLUGINS="bcrypt ep_hash_auth ep_export_cp_html_image ep_colors ep_headings ep_align ep_subscript ep_superscript ep_timesliderdiff ep_comments_page"
